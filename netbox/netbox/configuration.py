...
@cimnine
cimnine Merge pull request #359 from devon-mar/login-timeout-fix
…
Latest commit 9d51762 on Nov 13, 2020
 History
 13 contributors
@cimnine@tobiasge@sdktr@nepeat@eemil@devon-mar@timrabl@shuichiro-makigaki@ryanmerolle@thde@ajknv@jgcasd
248 lines (200 sloc)  12.9 KB
...
DATABASE = {
    ...
    'USER': environ.get('DB_USER', 'netbox'),                  # PostgreSQL username
    'PASSWORD': _read_secret('db_password', environ.get('DB_PASSWORD', 'J5brHrAXFLQSif0K')),
                                                         # PostgreSQL password
