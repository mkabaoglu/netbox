...
"""
Zone_Link = """
<a href="{% url 'dns:zone_view' pk=record.pk %}">
    {{ record.name|default:'<span class="label label-info">Unnamed device</span>' }}
</a>
"""
record_Link = """
<a href="{% url 'dns:record_list' %}">
    {{ record.r_name|default:'<span class="label label-info">Unnamed device</span>' }}
</a>
"""
record_Zone_link = """
<a href="{% url 'dns:record_view' pk=record.pk %}">
    {{ record.name|default:'<span class="label label-info">Unnamed device</span>' }}
</a>
"""
