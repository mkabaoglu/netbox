...
class ZoneFilterSet(BaseFilterSet, NameSlugSearchFilterSet):
    
    class Meta:
        model = Zone
        fields = ['id', 'name']
class recordFilterSet(BaseFilterSet, NameSlugSearchFilterSet):
    
    class Meta:
        model = record
        fields = [ 'r_name', 'r_type','r_value','r_ttl']
