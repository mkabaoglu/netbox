...
from . import views
from .models import Cluster, ClusterGroup, ClusterType, VirtualMachine, VMInterface,Services
from virtualization.views import ServicesEditView
...
urlpatterns = [
    ...
    path('clusters/<int:device>/services/assign/', ServicesEditView.as_view(), name='device_services_assign'), 
    # Virtual machines
    ...
    path('services/import/', views.ServicesBulkImportView.as_view(), name='services_import'),
    path('services/edit/', views.ServicesBulkEditView.as_view(), name='services_bulk_edit'),
    path('services/delete/', views.ServicesBulkDeleteView.as_view(), name='services_bulk_delete'),
    path('services/<int:pk>/', views.ServicesView.as_view(), name='services'),
    path('services/<int:pk>/edit/', views.ServicesEditView.as_view(), name='services_edit'),
    path('services/<int:pk>/delete/', views.ServicesDeleteView.as_view(), name='services_delete'),
    path('services/<int:pk>/changelog/', ObjectChangeLogView.as_view(), name='services_changelog', kwargs={'model': Services}),
