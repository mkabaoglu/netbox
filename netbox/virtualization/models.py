...
@extras_features('custom_fields', 'custom_links', 'export_templates', 'webhooks')
class Services(ChangeLoggedModel, CustomFieldModel):
    """
    ...
    tags = TaggableManager(through=TaggedItem,related_name='Services')

    objects = RestrictedQuerySet.as_manager()

    csv_headers = [ 'cluster', 'name', 'protocol', 'ports','Domain', 'description']
    ...
    def get_absolute_url(self):
        return reverse('virtualization:services', args=[self.pk])
